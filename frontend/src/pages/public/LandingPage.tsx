...
import { ArrowRight, Wifi, Zap, Smartphone, CheckCircle2, Shield, Globe, Menu, X } from 'lucide-react';
          ...
          <div className="container mx-auto p-4 md:hidden border-t bg-background animate-in slide-in-from-top-2">
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex flex-col gap-2 pt-2 border-t">
                <Button variant="outline" className="w-full justify-center" render={<Link to="/login" />} nativeButton={false}>
                  Log in
                </Button>
                <Button className="w-full justify-center" render={<Link to="/register" />} nativeButton={false}>
                  Get Connected
                </Button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li><a href="#" className="hover:text-foreground transition-colors">Reseller Program</a></li>
              </ul>
            </div>
